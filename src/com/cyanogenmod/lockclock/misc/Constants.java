...
public class Constants {
    ...
    public static final int CALENDAR_FORMAT_TIME = DateUtils.FORMAT_SHOW_TIME
												|  DateUtils.FORMAT_NO_NOON
												|  DateUtils.FORMAT_NO_MIDNIGHT;
    public static final int CALENDAR_FORMAT_ABBREV_DATE = DateUtils.FORMAT_SHOW_WEEKDAY
														| DateUtils.FORMAT_ABBREV_ALL;
    public static final int CALENDAR_FORMAT_ABBREV_DATETIME = CALENDAR_FORMAT_ABBREV_DATE
